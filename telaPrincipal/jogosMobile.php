...
<head>
    ...
    <title>Comunidade - Mobile| Gamer Friends</title>
    <!-- Bootstrap -->
    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            ...
            <div class="col-12" id="nave-tipo">             
              <strong><a href="comunidade.php">Jogos Pc/Console</a></strong> 
              <strong><a id="mobile">Mobile</a></strong>
            </div>
            <br><br>
            <!-- CONTEUDO -->
          <div class="container-fluid" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
            <div class="card mb-3"  style="max-width: 300px;">
              <div class="row g-0">
                <div class="col-md-4">
                  <img src="../img/free_fire.jpg" class="img-fluid rounded-start" alt="Valorant">
                </div>
                <div class="col-md-8">
                  <div class="card-body">
                    <h3 class="card-title">Free Fire</h3>
